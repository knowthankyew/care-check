...
export const DefenseStudio: React.FC<DefenseStudioProps> = ({
  ...
  return (
    <aside className="panel defense-column">
      ...
      {/* Non-Waivable UPL Legal Disclaimer Banner */}
      <div
        className="upl-banner"
        style={{
      ...
      >
        ...
        <div>
          <strong style={{ color: '#fbbf24' }}>Non-Waivable Legal Disclaimer:</strong>{' '}
          This document was generated by an automated open-source software tool for informational advocacy purposes and does not constitute formal legal advice. CareCheck is not a law firm and does not provide legal representation.
        </div>
      </div>
