...
export function generateDisputeLetter(payload: DisputeLetterPayload): GeneratedDocument {
  ...
  const statutoryCitations: string[] = [
    ...
    'Internal Revenue Code Section 501(r)(6) [26 U.S.C. § 501(r)(6)] - Prohibition of Extraordinary Collection Actions (ECAs) by Tax-Exempt Hospitals',
    ...
    'Fair Debt Collection Practices Act (FDCPA) [15 U.S.C. § 1692g] - Written Validation of Debts & Collection Cessation (Applicable to Third-Party Debt Collectors)',
  ];
  ...
  const legalDisclaimerMarkdown = `\n\n---\n**Notice & Self-Advocacy Disclaimer:** This document was generated by an automated open-source software tool for informational advocacy purposes and does not constitute formal legal advice. CareCheck is not a law firm, does not provide legal representation, and does not create an attorney-client relationship. If you are facing active collection litigation, court summons, or wage garnishment, consult a licensed attorney or accredited consumer defense specialist.`;
...
1. Immediately place this account on a collection hold under 26 U.S.C. § 501(r)(6) and suspend all hospital billing enforcement. If this account has been assigned to a third-party debt collection agency, notify them immediately that this account is subject to a formal 501(r) dispute and statutory ECA hold, and note that third-party collection agencies are additionally bound by the debt validation and collection cessation requirements of 15 U.S.C. § 1692g.
...
Furthermore, as the billing department of this healthcare provider, you are required under Section 501(r)(6) of the Internal Revenue Code (**26 U.S.C. § 501(r)(6)**) and federal consumer protection standards to halt collection actions during an active dispute. I demand:
1. Immediate cessation of any collection attempts, adverse credit reporting, or referral to third-party collection agencies pursuant to 26 U.S.C. § 501(r)(6).
...
4. If this account has already been referred or assigned to an external third-party collection agency, please be advised that under the Fair Debt Collection Practices Act (**15 U.S.C. § 1692g**), this notice constitutes a formal dispute requiring the debt collector to immediately cease all collection activities until full written verification of the debt is furnished.
...
### ${patientNotes ? '4' : '3'}. Safe Harbor Invocation Under 26 U.S.C. § 501(r)(6) & FDCPA Advisory
This notice formally invokes statutory safe harbor protections under **26 U.S.C. § 501(r)(6)** and **26 CFR § 1.501(r)-6**. The hospital billing department must immediately halt all Extraordinary Collection Actions (ECAs), including third-party referrals, adverse credit reporting, and legal proceedings, until this application and dispute are fully processed.

To the extent this account has been transferred or assigned to an external third-party collection agency, notice is hereby given that the debt is formally disputed under the Fair Debt Collection Practices Act (**15 U.S.C. § 1692g**), mandating that the third-party debt collector immediately cease all collection activities until full written verification is provided.
...
<body>
  <div class="upl-disclaimer no-print">
    <strong>Notice & Self-Advocacy Disclaimer:</strong> This document was generated by an automated open-source software tool for informational advocacy purposes and does not constitute formal legal advice. Consult a licensed attorney or accredited patient advocate for legal representation.
  </div>
  ${htmlLines.join('\n')}
</body>
</html>`;
